 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _S="FirebaseError";class Gt extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=_S,Object.setPrototypeOf(this,Gt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,er.prototype.create)}}class er{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?bS(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Gt(s,a,i)}}function bS(t,e){return t.replace(IS,(n,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const IS=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DS{constructor(e,n){this.name=e,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const n=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(n)){const i=new mS;if(this.instancesDeferred.set(n,i),this.isInitialized(n)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:n});s&&i.resolve(s)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(e){var n;const i=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),s=(n=e==null?void 0:e.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(i)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:i})}catch(r){if(s)return null;throw r}else{if(s)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(kS(e))try{this.getOrInitializeService({instanceIdentifier:cs})}catch{}for(const[n,i]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(n);try{const r=this.getOrInitializeService({instanceIdentifier:s});i.resolve(r)}catch{}}}}clearInstance(e=cs){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...e.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=cs){return this.instances.has(e)}getOptions(e=cs){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:n={}}=e,i=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(i))throw Error(`${this.name}(${i}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:i,options:n});for(const[r,o]of this.instancesDeferred.entries()){const a=this.normalizeInstanceIdentifier(r);i===a&&o.resolve(s)}return s}onInit(e,n){var i;const s=this.normalizeInstanceIdentifier(n),r=(i=this.onInitCallbacks.get(s))!==null&&i!==void 0?i:new Set;r.add(e),this.onInitCallbacks.set(s,r);const o=this.instances.get(s);return o&&e(o,s),()=>{r.delete(e)}}invokeOnInitCallbacks(e,n){const i=this.onInitCallbacks.get(n);if(!!i)for(const s of i)try{s(e,n)}catch{}}getOrInitializeService({instanceIdentifier:e,options:n={}}){let i=this.instances.get(e);if(!i&&this.component&&(i=this.component.instanceFactory(this.container,{instanceIdentifier:AS(e),options:n}),this.instances.set(e,i),this.instancesOptions.set(e,n),this.invokeOnInitCallbacks(i,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,i)}catch{}return i||null}normalizeInstanceIdentifier(e=cs){return this.component?this.component.multipleInstances?e:cs:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function AS(t){return t===cs?void 0:t}function kS(t){return t.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GS{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(KS(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function KS(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Rh="@firebase/app",Op="0.7.33";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eA(t,e){return wt(t,"POST","/v1/accounts:delete",e)}async function tA(t,e){return wt(t,"POST","/v1/accounts:update",e)}async function nA(t,e){return wt(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Go(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function iA(t,e=!1){const n=te(t),i=await n.getIdToken(e),s=jc(i);F(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:Go(Ku(s.auth_time)),issuedAtTime:Go(Ku(s.iat)),expirationTime:Go(Ku(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Ku(t){return Number(t)*1e3}function jc(t){var e;const[n,i,s]=t.split(".");if(n===void 0||i===void 0||s===void 0)return Nl("JWT malformed, contained fewer than 3 sections"),null;try{const r=dS(i);return r?JSON.parse(r):(Nl("Failed to decode base64 JWT payload"),null)}catch(r){return Nl("Caught error parsing JWT payload as JSON",(e=r)===null||e===void 0?void 0:e.toString()),null}}function sA(t){const e=jc(t);return F(e,"internal-error"),F(typeof e.exp<"u","internal-error"),F(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ci(t,e,n=!1){if(n)return e;try{return await e}catch(i){throw i instanceof Gt&&rA(i)&&t.auth.currentUser===t&&await t.auth.signOut(),i}}function rA({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ga(t){var e;const n=t.auth,i=await t.getIdToken(),s=await ci(t,nA(n,{idToken:i}));F(s==null?void 0:s.users.length,n,"internal-error");const r=s.users[0];t._notifyReloadListener(r);const o=!((e=r.providerUserInfo)===null||e===void 0)&&e.length?cA(r.providerUserInfo):[],a=lA(t.providerData,o),l=t.isAnonymous,c=!(t.email&&r.passwordHash)&&!(a!=null&&a.length),u=l?c:!1,h={uid:r.localId,displayName:r.displayName||null,photoURL:r.photoUrl||null,email:r.email||null,emailVerified:r.emailVerified||!1,phoneNumber:r.phoneNumber||null,tenantId:r.tenantId||null,providerData:a,metadata:new Tw(r.createdAt,r.lastLoginAt),isAnonymous:u};Object.assign(t,h)}async function aA(t){const e=te(t);await ga(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function lA(t,e){return[...t.filter(i=>!e.some(s=>s.providerId===i.providerId)),...e]}function cA(t){return t.map(e=>{var{providerId:n}=e,i=zd(e,["providerId"]);return{providerId:n,uid:i.rawId||"",displayName:i.displayName||null,email:i.email||null,phoneNumber:i.phoneNumber||null,photoURL:i.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uA(t,e){const n=await Iw(t,{},async()=>{const i=Xr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=t.config,o=Ew(t,s,"/v1/token",`key=${r}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",bw.fetch()(o,{method:"POST",headers:a,body:i})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class va{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){F(e.idToken,"internal-error"),F(typeof e.idToken<"u","internal-error"),F(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):sA(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}async getToken(e,n=!1){return F(!this.accessToken||this.refreshToken,e,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:i,refreshToken:s,expiresIn:r}=await uA(e,n);this.updateTokensAndExpiration(i,s,Number(r))}updateTokensAndExpiration(e,n,i){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(e,n){const{refreshToken:i,accessToken:s,expirationTime:r}=n,o=new va;return i&&(F(typeof i=="string","internal-error",{appName:e}),o.refreshToken=i),s&&(F(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),r&&(F(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new va,this.toJSON())}_performRefresh(){return Un("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $p(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(kw(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Dw(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Cw(e))return"Blackberry";if(Ow(e))return"Webos";if(Jd(e))return"Safari";if((e.includes("chrome/")||Aw(e))&&!e.includes("edge/"))return"Chrome";if(qa(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Dw(t=ze()){return/firefox\//i.test(t)}function Jd(t=ze()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Aw(t=ze()){return/crios\//i.test(t)}function kw(t=ze()){return/iemobile/i.test(t)}function qa(t=ze()){return/android/i.test(t)}function Cw(t=ze()){return/blackberry/i.test(t)}function Ow(t=ze()){return/webos/i.test(t)}function to(t=ze()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function hA(t=ze()){return/(iPad|iPhone|iPod).*OS 7_\d/i.test(t)||/(iPad|iPhone|iPod).*OS 8_\d/i.test(t)}function dA(t=ze()){var e;return to(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function fA(){return sw()&&document.documentMode===10}function Nw(t=ze()){return to(t)||qa(t)||Ow(t)||Cw(t)||/windows phone/i.test(t)||kw(t)}function mA(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rw(t,e){return wt(t,"POST","/v1/accounts:resetPassword",lt(t,e))}async function Lw(t,e){return wt(t,"POST","/v1/accounts:update",e)}async function _A(t,e){return wt(t,"POST","/v1/accounts:update",lt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bA(t,e){return fi(t,"POST","/v1/accounts:signInWithPassword",lt(t,e))}async function qc(t,e){return wt(t,"POST","/v1/accounts:sendOobCode",lt(t,e))}async function IA(t,e){return qc(t,e)}async function EA(t,e){return qc(t,e)}async function TA(t,e){return qc(t,e)}async function SA(t,e){return qc(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function DA(t,e){return fi(t,"POST","/v1/accounts:signInWithEmailLink",lt(t,e))}async function AA(t,e){return fi(t,"POST","/v1/accounts:signInWithEmailLink",lt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function CA(t,e){return wt(t,"POST","/v1/accounts:sendVerificationCode",lt(t,e))}async function OA(t,e){return fi(t,"POST","/v1/accounts:signInWithPhoneNumber",lt(t,e))}async function NA(t,e){const n=await fi(t,"POST","/v1/accounts:signInWithPhoneNumber",lt(t,e));if(n.temporaryProof)throw Ro(t,"account-exists-with-different-credential",n);return n}const xA={USER_NOT_FOUND:"user-not-found"};async function MA(t,e){const n=Object.assign(Object.assign({},e),{operation:"REAUTH"});return fi(t,"POST","/v1/accounts:signInWithPhoneNumber",lt(t,n),xA)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RA(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function LA(t){const e=wr(Mo(t)).link,n=e?wr(Mo(e)).deep_link_id:null,i=wr(Mo(t)).deep_link_id;return(i?wr(Mo(i)).link:null)||i||n||e||t}class Hc{constructor(e){var n,i,s,r,o,a;const l=wr(Mo(e)),c=(n=l.apiKey)!==null&&n!==void 0?n:null,u=(i=l.oobCode)!==null&&i!==void 0?i:null,h=RA((s=l.mode)!==null&&s!==void 0?s:null);F(c&&u&&h,"argument-error"),this.apiKey=c,this.operation=h,this.code=u,this.continueUrl=(r=l.continueUrl)!==null&&r!==void 0?r:null,this.languageCode=(o=l.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=l.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=LA(e);try{return new Hc(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $A(t,e){const n=te(t);await Wc(!0,n,e);const{providerUserInfo:i}=await tA(n.auth,{idToken:await n.getIdToken(),deleteProvider:[e]}),s=Fw(i||[]);return n.providerData=n.providerData.filter(r=>s.has(r.providerId)),s.has("phone")||(n.phoneNumber=null),await n.auth._persistUserIfCurrent(n),n}async function Xd(t,e,n=!1){const i=await ci(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return vn._forOperation(t,"link",i)}async function Wc(t,e,n){await ga(e);const i=Fw(e.providerData),s=t===!1?"provider-already-linked":"no-such-provider";F(i.has(n)===t,e.auth,s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uw(t,e,n=!1){const i="signIn",s=await Vw(t,i,e),r=await vn._fromIdTokenResponse(t,i,s);return n||await t._updateCurrentUser(r.user),r}async function Gc(t,e){return Uw(vt(t),e)}async function Bw(t,e){const n=te(t);return await Wc(!1,n,e.providerId),Xd(n,e)}async function jw(t,e){return $w(te(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function UA(t,e){return fi(t,"POST","/v1/accounts:signInWithCustomToken",lt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function BA(t,e){const n=vt(t),i=await UA(n,{token:e,returnSecureToken:!0}),s=await vn._fromIdTokenResponse(n,"signIn",i);return await n._updateCurrentUser(s.user),s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jA(t,e,n){const i=te(t),s={requestType:"PASSWORD_RESET",email:e};n&&zc(i,s,n),await EA(i,s)}async function qA(t,e,n){await Rw(te(t),{oobCode:e,newPassword:n})}async function HA(t,e){await _A(te(t),{oobCode:e})}async function qw(t,e){const n=te(t),i=await Rw(n,{oobCode:e}),s=i.requestType;switch(F(s,n,"internal-error"),s){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":F(i.newEmail,n,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":F(i.mfaInfo,n,"internal-error");default:F(i.email,n,"internal-error")}let r=null;return i.mfaInfo&&(r=Kc._fromServerResponse(vt(n),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:r},operation:s}}async function WA(t,e){const{data:n}=await qw(te(t),e);return n.email}async function GA(t,e,n){const i=vt(t),s=await Pw(i,{returnSecureToken:!0,email:e,password:n}),r=await vn._fromIdTokenResponse(i,"signIn",s);return await i._updateCurrentUser(r.user),r}function KA(t,e,n){return Gc(te(t),Yi.credential(e,n))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zA(t,e,n){const i=te(t),s={requestType:"EMAIL_SIGNIN",email:e};F(n.handleCodeInApp,i,"argument-error"),n&&zc(i,s,n),await TA(i,s)}function YA(t,e){const n=Hc.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function QA(t,e,n){const i=te(t),s=Yi.credentialWithLink(e,n||pa());return F(s._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),Gc(i,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ZA(t,e){return wt(t,"POST","/v1/accounts:createAuthUri",lt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function JA(t,e){const n=Qd()?pa():"http://localhost",i={identifier:e,continueUri:n},{signinMethods:s}=await ZA(te(t),i);return s||[]}async function XA(t,e){const n=te(t),i=await t.getIdToken(),s={requestType:"VERIFY_EMAIL",idToken:i};e&&zc(n.auth,s,e);const{email:r}=await IA(n.auth,s);r!==t.email&&await t.reload()}async function ek(t,e,n){const i=te(t),s=await t.getIdToken(),r={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:s,newEmail:e};n&&zc(i.auth,r,n);const{email:o}=await SA(i.auth,r);o!==t.email&&await t.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tk(t,e){return wt(t,"POST","/v1/accounts:update",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nk(t,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const i=te(t),r={idToken:await i.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},o=await ci(i,tk(i.auth,r));i.displayName=o.displayName||null,i.photoURL=o.photoUrl||null;const a=i.providerData.find(({providerId:l})=>l==="password");a&&(a.displayName=i.displayName,a.photoURL=i.photoURL),await i._updateTokensIfNecessary(o)}function ik(t,e){return Hw(te(t),e,null)}function sk(t,e){return Hw(te(t),null,e)}async function Hw(t,e,n){const{auth:i}=t,r={idToken:await t.getIdToken(),returnSecureToken:!0};e&&(r.email=e),n&&(r.password=n);const o=await ci(t,Lw(i,r));await t._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rk(t){var e,n;if(!t)return null;const{providerId:i}=t,s=t.rawUserInfo?JSON.parse(t.rawUserInfo):{},r=t.isNewUser||t.kind==="identitytoolkit#SignupNewUserResponse";if(!i&&(t==null?void 0:t.idToken)){const o=(n=(e=jc(t.idToken))===null||e===void 0?void 0:e.firebase)===null||n===void 0?void 0:n.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new kr(r,a)}}if(!i)return null;switch(i){case"facebook.com":return new ok(r,s);case"github.com":return new ak(r,s);case"google.com":return new lk(r,s);case"twitter.com":return new ck(r,s,t.screenName||null);case"custom":case"anonymous":return new kr(r,null);default:return new kr(r,i,s)}}class kr{constructor(e,n,i={}){this.isNewUser=e,this.providerId=n,this.profile=i}}class Ww extends kr{constructor(e,n,i,s){super(e,n,i),this.username=s}}class ok extends kr{constructor(e,n){super(e,"facebook.com",n)}}class ak extends Ww{constructor(e,n){super(e,"github.com",n,typeof(n==null?void 0:n.login)=="string"?n==null?void 0:n.login:null)}}class lk extends kr{constructor(e,n){super(e,"google.com",n)}}class ck extends Ww{constructor(e,n,i){super(e,"twitter.com",n,i)}}function uk(t){const{user:e,_tokenResponse:n}=t;return e.isAnonymous&&!n?{providerId:null,isNewUser:!1,profile:null}:rk(n)}class _s{constructor(e,n,i){this.type=e,this.credential=n,this.auth=i}static _fromIdtoken(e,n){return new _s("enroll",e,n)}static _fromMfaPendingCredential(e){return new _s("signin",e)}toJSON(){return{multiFactorSession:{[this.type==="enroll"?"idToken":"pendingCredential"]:this.credential}}}static fromJSON(e){var n,i;if(e!=null&&e.multiFactorSession){if(!((n=e.multiFactorSession)===null||n===void 0)&&n.pendingCredential)return _s._fromMfaPendingCredential(e.multiFactorSession.pendingCredential);if(!((i=e.multiFactorSession)===null||i===void 0)&&i.idToken)return _s._fromIdtoken(e.multiFactorSession.idToken)}return null}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dk(t,e){return wt(t,"POST","/v2/accounts/mfaEnrollment:start",lt(t,e))}function fk(t,e){return wt(t,"POST","/v2/accounts/mfaEnrollment:finalize",lt(t,e))}function mk(t,e){return wt(t,"POST","/v2/accounts/mfaEnrollment:withdraw",lt(t,e))}class nf{constructor(e){this.user=e,this.enrolledFactors=[],e._onReload(n=>{n.mfaInfo&&(this.enrolledFactors=n.mfaInfo.map(i=>Kc._fromServerResponse(e.auth,i)))})}static _fromUser(e){return new nf(e)}async getSession(){return _s._fromIdtoken(await this.user.getIdToken(),this.user.auth)}async enroll(e,n){const i=e,s=await this.getSession(),r=await ci(this.user,i._process(this.user.auth,s,n));return await this.user._updateTokensIfNecessary(r),this.user.reload()}async unenroll(e){var n;const i=typeof e=="string"?e:e.uid,s=await this.user.getIdToken(),r=await ci(this.user,mk(this.user.auth,{idToken:s,mfaEnrollmentId:i}));this.enrolledFactors=this.enrolledFactors.filter(({uid:o})=>o!==i),await this.user._updateTokensIfNecessary(r);try{await this.user.reload()}catch(o){if(((n=o)===null||n===void 0?void 0:n.code)!=="auth/user-token-expired")throw o}}}const zu=new WeakMap;function pk(t){const e=te(t);return zu.has(e)||zu.set(e,nf._fromUser(e)),zu.get(e)}const Jl="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zw extends Gw{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}zw.type="SESSION";const Ps=zw;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yc{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const n=this.receivers.find(s=>s.isListeningto(e));if(n)return n;const i=new Yc(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const n=e,{eventId:i,eventType:s,data:r}=n.data,o=this.handlersMap[s];if(!(o!=null&&o.size))return;n.ports[0].postMessage({status:"ack",eventId:i,eventType:s});const a=Array.from(o).map(async c=>c(n.origin,r)),l=await wk(a);n.ports[0].postMessage({status:"done",eventId:i,eventType:s,response:l})}_subscribe(e,n){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(n)}_unsubscribe(e,n){this.handlersMap[e]&&n&&this.handlersMap[e].delete(n),(!n||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}Yc.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ot(){return window}function bk(t){ot().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rf(){return typeof ot().WorkerGlobalScope<"u"&&typeof ot().importScripts=="function"}async function Ik(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Ek(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function Tk(){return rf()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ok(t,e){return wt(t,"POST","/v2/accounts/mfaSignIn:start",lt(t,e))}function Nk(t,e){return wt(t,"POST","/v2/accounts/mfaSignIn:finalize",lt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xk(t){return(await wt(t,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mk(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}function Jw(t){return new Promise((e,n)=>{const i=document.createElement("script");i.setAttribute("src",t),i.onload=e,i.onerror=s=>{const r=At("internal-error");r.customData=s,n(r)},i.type="text/javascript",i.charset="UTF-8",Mk().appendChild(i)})}function Xw(t){return`__${t}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yu=Xw("rcb"),$k=new ja(3e4,6e4),Uk="https://www.google.com/recaptcha/api.js?";class Bk{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!(!((e=ot().grecaptcha)===null||e===void 0)&&e.render)}load(e,n=""){return F(jk(n),e,"argument-error"),this.shouldResolveImmediately(n)?Promise.resolve(ot().grecaptcha):new Promise((i,s)=>{const r=ot().setTimeout(()=>{s(At(e,"network-request-failed"))},$k.get());ot()[Yu]=()=>{ot().clearTimeout(r),delete ot()[Yu];const a=ot().grecaptcha;if(!a){s(At(e,"internal-error"));return}const l=a.render;a.render=(c,u)=>{const h=l(c,u);return this.counter++,h},this.hostLanguage=n,i(a)};const o=`${Uk}?${Xr({onload:Yu,render:"explicit",hl:n})}`;Jw(o).catch(()=>{clearTimeout(r),s(At(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var n;return!!(!((n=ot().grecaptcha)===null||n===void 0)&&n.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function jk(t){return t.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(t)}class qk{async load(e){return new Pk(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class of{constructor(e,n){this.verificationId=e,this.onConfirmation=n}confirm(e){const n=Cs._fromVerification(this.verificationId,e);return this.onConfirmation(n)}}async function Kk(t,e,n){const i=vt(t),s=await Zc(i,e,te(n));return new of(s,r=>Gc(i,r))}async function zk(t,e,n){const i=te(t);await Wc(!1,i,"phone");const s=await Zc(i.auth,e,te(n));return new of(s,r=>Bw(i,r))}async function Yk(t,e,n){const i=te(t),s=await Zc(i.auth,e,te(n));return new of(s,r=>jw(i,r))}async function Zc(t,e,n){var i;const s=await n.verify();try{F(typeof s=="string",t,"argument-error"),F(n.type===e_,t,"argument-error");let r;if(typeof e=="string"?r={phoneNumber:e}:r=e,"session"in r){const o=r.session;if("phoneNumber"in r)return F(o.type==="enroll",t,"internal-error"),(await dk(t,{idToken:o.credential,phoneEnrollmentInfo:{phoneNumber:r.phoneNumber,recaptchaToken:s}})).phoneSessionInfo.sessionInfo;{F(o.type==="signin",t,"internal-error");const a=((i=r.multiFactorHint)===null||i===void 0?void 0:i.uid)||r.multiFactorUid;return F(a,t,"missing-multi-factor-info"),(await Ok(t,{mfaPendingCredential:o.credential,mfaEnrollmentId:a,phoneSignInInfo:{recaptchaToken:s}})).phoneResponseInfo.sessionInfo}}else{const{sessionInfo:o}=await CA(t,{phoneNumber:r.phoneNumber,recaptchaToken:s});return o}}finally{n._reset()}}async function Qk(t,e){await Xd(te(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class t_{constructor(e,n,i,s,r=!1){this.auth=e,this.resolver=i,this.user=s,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:i,postBody:s,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:n,sessionId:i,tenantId:r||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(l))}catch(c){this.reject(c)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Zk;case"linkViaPopup":case"linkViaRedirect":return Xk;case"reauthViaPopup":case"reauthViaRedirect":return Jk;default:Ct(this.auth,"internal-error")}}resolve(e){Dn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Dn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sC="pendingRedirect",Ko=new Map;class rC extends t_{constructor(e,n,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i),this.eventId=null}async execute(){let e=Ko.get(this.auth._key());if(!e){try{const i=await oC(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(n){e=()=>Promise.reject(n)}Ko.set(this.auth._key(),e)}return this.bypassAuthState||Ko.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function oC(t,e){const n=i_(e),i=n_(t);if(!await i._isAvailable())return!1;const s=await i._get(n)==="true";return await i._remove(n),s}async function lf(t,e){return n_(t)._set(i_(e),"true")}function aC(){Ko.clear()}function cf(t,e){Ko.set(t._key(),e)}function n_(t){return on(t._redirectPersistence)}function i_(t){return ks(sC,t.config.apiKey,t.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bC=new ja(3e4,6e4);function Gp(){const t=ot().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function IC(t){return new Promise((e,n)=>{var i,s,r;function o(){Gp(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Gp(),n(At(t,"network-request-failed"))},timeout:bC.get()})}if(!((s=(i=ot().gapi)===null||i===void 0?void 0:i.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((r=ot().gapi)===null||r===void 0)&&r.load)o();else{const a=Xw("iframefcb");return ot()[a]=()=>{gapi.load?o():n(At(t,"network-request-failed"))},Jw(`https://apis.google.com/js/api.js?onload=${a}`).catch(l=>n(l))}}).catch(e=>{throw xl=null,e})}let xl=null;function EC(t){return xl=xl||IC(t),xl}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TC=new ja(5e3,15e3),SC="__/auth/iframe",DC="emulator/auth/iframe",AC={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},kC=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function CC(t){const e=t.config;F(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Zd(e,DC):`https://${t.config.authDomain}/${SC}`,i={apiKey:e.apiKey,appName:t.name,v:tr},s=kC.get(t.config.apiHost);s&&(i.eid=s);const r=t._getFrameworks();return r.length&&(i.fw=r.join(",")),`${n}?${Xr(i).slice(1)}`}async function OC(t){const e=await EC(t),n=ot().gapi;return F(n,t,"internal-error"),e.open({where:document.body,url:CC(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:AC,dontclear:!0},i=>new Promise(async(s,r)=>{await i.restyle({setHideOnLeave:!1});const o=At(t,"network-request-failed"),a=ot().setTimeout(()=>{r(o)},TC.get());function l(){ot().clearTimeout(a),s(i)}i.ping(l).then(l,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const NC={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},xC=500,MC=600,RC="_blank",LC="http://localhost";class Kp{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function PC(t,e,n,i=xC,s=MC){const r=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const l=Object.assign(Object.assign({},NC),{width:i.toString(),height:s.toString(),top:r,left:o}),c=ze().toLowerCase();n&&(a=Aw(c)?RC:n),Dw(c)&&(e=e||LC,l.scrollbars="yes");const u=Object.entries(l).reduce((d,[f,g])=>`${d}${f}=${g},`,"");if(dA(c)&&a!=="_self")return VC(e||"",a),new Kp(null);const h=window.open(e||"",a,u);F(h,t,"popup-blocked");try{h.focus()}catch{}return new Kp(h)}function VC(t,e){const n=document.createElement("a");n.href=t,n.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function WC(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function GC(t){Vi(new Kn("auth",(e,{options:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),{apiKey:r,authDomain:o}=i.options;return((a,l)=>{F(r&&!r.includes(":"),"invalid-api-key",{appName:a.name}),F(!(o!=null&&o.includes(":")),"argument-error",{appName:a.name});const c={apiKey:r,authDomain:o,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:xw(t)},u=new gA(a,l,c);return zD(u,n),u})(i,s)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,i)=>{e.getProvider("auth-internal").initialize()})),Vi(new Kn("auth-internal",e=>{const n=vt(e.getProvider("auth").getImmediate());return(i=>new HC(i))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Tn(zp,Yp,WC(t)),Tn(zp,Yp,"esm2017")}GC("Browser");/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tO=20;class nO extends r_{constructor(){super(...arguments),this.passiveListeners=new Set,this.initPromise=new Promise(e=>{this.resolveInialized=e})}addPassiveListener(e){this.passiveListeners.add(e)}removePassiveListener(e){this.passiveListeners.delete(e)}resetRedirect(){this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1}onEvent(e){return this.resolveInialized(),this.passiveListeners.forEach(n=>n(e)),super.onEvent(e)}async initialized(){await this.initPromise}}function iO(t,e,n=null){return{type:e,eventId:n,urlResponse:null,sessionId:oO(),postBody:null,tenantId:t.tenantId,error:At(t,"no-auth-event")}}function sO(t,e){return Vh()._set(Fh(t),e)}async function Qp(t){const e=await Vh()._get(Fh(t));return e&&await Vh()._remove(Fh(t)),e}function rO(t,e){var n,i;const s=lO(e);if(s.includes("/__/auth/callback")){const r=Ml(s),o=r.firebaseError?aO(decodeURIComponent(r.firebaseError)):null,a=(i=(n=o==null?void 0:o.code)===null||n===void 0?void 0:n.split("auth/"))===null||i===void 0?void 0:i[1],l=a?At(a):null;return l?{type:t.type,eventId:t.eventId,tenantId:t.tenantId,error:l,urlResponse:null,sessionId:null,postBody:null}:{type:t.type,eventId:t.eventId,tenantId:t.tenantId,sessionId:t.sessionId,urlResponse:s,postBody:null}}return null}function oO(){const t=[],e="1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";for(let n=0;n<tO;n++){const i=Math.floor(Math.random()*e.length);t.push(e.charAt(i))}return t.join("")}function Vh(){return on(sf)}function Fh(t){return ks("authEvent",t.config.apiKey,t.name)}function aO(t){try{return JSON.parse(t)}catch{return null}}function lO(t){const e=Ml(t),n=e.link?decodeURIComponent(e.link):void 0,i=Ml(n).link,s=e.deep_link_id?decodeURIComponent(e.deep_link_id):void 0;return Ml(s).link||s||i||n||t}function Ml(t){if(!(t!=null&&t.includes("?")))return{};const[e,...n]=t.split("?");return wr(n.join("?"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cO=500;class uO{constructor(){this._redirectPersistence=Ps,this._shouldInitProactively=!0,this.eventManagers=new Map,this.originValidationPromises={},this._completeRedirectFn=Jc,this._overrideRedirectResult=cf}async _initialize(e){const n=e._key();let i=this.eventManagers.get(n);return i||(i=new nO(e),this.eventManagers.set(n,i),this.attachCallbackListeners(e,i)),i}_openPopup(e){Ct(e,"operation-not-supported-in-this-environment")}async _openRedirect(e,n,i,s){JC(e);const r=await this._initialize(e);await r.initialized(),r.resetRedirect(),aC(),await this._originValidation(e);const o=iO(e,i,s);await sO(e,o);const a=await zC(e,o,n),l=await QC(a);return ZC(e,r,l)}_isIframeWebStorageSupported(e,n){throw new Error("Method not implemented.")}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=YC(e)),this.originValidationPromises[n]}attachCallbackListeners(e,n){const{universalLinks:i,handleOpenURL:s,BuildInfo:r}=Vs(),o=setTimeout(async()=>{await Qp(e),n.onEvent(Zp())},cO),a=async u=>{clearTimeout(o);const h=await Qp(e);let d=null;h&&(u==null?void 0:u.url)&&(d=rO(h,u.url)),n.onEvent(d||Zp())};typeof i<"u"&&typeof i.subscribe=="function"&&i.subscribe(null,a);const l=s,c=`${r.packageName.toLowerCase()}://`;Vs().handleOpenURL=async u=>{if(u.toLowerCase().startsWith(c)&&a({url:u}),typeof l=="function")try{l(u)}catch(h){console.error(h)}}}}const hO=uO;function Zp(){return{type:"unknown",eventId:null,sessionId:null,urlResponse:null,postBody:null,tenantId:null,error:At("no-auth-event")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class si{constructor(e){this._delegate=e,this.multiFactor=pk(e)}static getOrCreate(e){return si.USER_MAP.has(e)||si.USER_MAP.set(e,new si(e)),si.USER_MAP.get(e)}delete(){return this._delegate.delete()}reload(){return this._delegate.reload()}toJSON(){return this._delegate.toJSON()}getIdTokenResult(e){return this._delegate.getIdTokenResult(e)}getIdToken(e){return this._delegate.getIdToken(e)}linkAndRetrieveDataWithCredential(e){return this.linkWithCredential(e)}async linkWithCredential(e){return Zt(this.auth,Bw(this._delegate,e))}async linkWithPhoneNumber(e,n){return Uh(this.auth,zk(this._delegate,e,n))}async linkWithPopup(e){return Zt(this.auth,iC(this._delegate,e,Ai))}async linkWithRedirect(e){return await $h(vt(this.auth)),dC(this._delegate,e,Ai)}reauthenticateAndRetrieveDataWithCredential(e){return this.reauthenticateWithCredential(e)}async reauthenticateWithCredential(e){return Zt(this.auth,jw(this._delegate,e))}reauthenticateWithPhoneNumber(e,n){return Uh(this.auth,Yk(this._delegate,e,n))}reauthenticateWithPopup(e){return Zt(this.auth,nC(this._delegate,e,Ai))}async reauthenticateWithRedirect(e){return await $h(vt(this.auth)),uC(this._delegate,e,Ai)}sendEmailVerification(e){return XA(this._delegate,e)}async unlink(e){return await $A(this._delegate,e),this}updateEmail(e){return ik(this._delegate,e)}updatePassword(e){return sk(this._delegate,e)}updatePhoneNumber(e){return Qk(this._delegate,e)}updateProfile(e){return nk(this._delegate,e)}verifyBeforeUpdateEmail(e,n){return ek(this._delegate,e,n)}get emailVerified(){return this._delegate.emailVerified}get isAnonymous(){return this._delegate.isAnonymous}get metadata(){return this._delegate.metadata}get phoneNumber(){return this._delegate.phoneNumber}get providerData(){return this._delegate.providerData}get refreshToken(){return this._delegate.refreshToken}get tenantId(){return this._delegate.tenantId}get displayName(){return this._delegate.displayName}get email(){return this._delegate.email}get photoURL(){return this._delegate.photoURL}get providerId(){return this._delegate.providerId}get uid(){return this._delegate.uid}get auth(){return this._delegate.auth}}si.USER_MAP=new WeakMap;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bo=F;class Bh{constructor(e,n){if(this.app=e,n.isInitialized()){this._delegate=n.getImmediate(),this.linkUnderlyingAuth();return}const{apiKey:i}=e.options;bo(i,"invalid-api-key",{appName:e.name}),bo(i,"invalid-api-key",{appName:e.name});const s=typeof window<"u"?Ai:void 0;this._delegate=n.initialize({options:{persistence:OO(i,e.name),popupRedirectResolver:s}}),this._delegate._updateErrorMap(GD),this.linkUnderlyingAuth()}get emulatorConfig(){return this._delegate.emulatorConfig}get currentUser(){return this._delegate.currentUser?si.getOrCreate(this._delegate.currentUser):null}get languageCode(){return this._delegate.languageCode}set languageCode(e){this._delegate.languageCode=e}get settings(){return this._delegate.settings}get tenantId(){return this._delegate.tenantId}set tenantId(e){this._delegate.tenantId=e}useDeviceLanguage(){this._delegate.useDeviceLanguage()}signOut(){return this._delegate.signOut()}useEmulator(e,n){vA(this._delegate,e,n)}applyActionCode(e){return HA(this._delegate,e)}checkActionCode(e){return qw(this._delegate,e)}confirmPasswordReset(e,n){return qA(this._delegate,e,n)}async createUserWithEmailAndPassword(e,n){return Zt(this._delegate,GA(this._delegate,e,n))}fetchProvidersForEmail(e){return this.fetchSignInMethodsForEmail(e)}fetchSignInMethodsForEmail(e){return JA(this._delegate,e)}isSignInWithEmailLink(e){return YA(this._delegate,e)}async getRedirectResult(){bo(Zu(),this._delegate,"operation-not-supported-in-this-environment");const e=await mC(this._delegate,Ai);return e?Zt(this._delegate,Promise.resolve(e)):{credential:null,user:null}}addFrameworkForLogging(e){dO(this._delegate,e)}onAuthStateChanged(e,n,i){const{next:s,error:r,complete:o}=Jp(e,n,i);return this._delegate.onAuthStateChanged(s,r,o)}onIdTokenChanged(e,n,i){const{next:s,error:r,complete:o}=Jp(e,n,i);return this._delegate.onIdTokenChanged(s,r,o)}sendSignInLinkToEmail(e,n){return zA(this._delegate,e,n)}sendPasswordResetEmail(e,n){return jA(this._delegate,e,n||void 0)}async setPersistence(e){EO(this._delegate,e);let n;switch(e){case rn.SESSION:n=Ps;break;case rn.LOCAL:n=await on(wa)._isAvailable()?wa:sf;break;case rn.NONE:n=Vr;break;default:return Ct("argument-error",{appName:this._delegate.name})}return this._delegate.setPersistence(n)}signInAndRetrieveDataWithCredential(e){return this.signInWithCredential(e)}signInAnonymously(){return Zt(this._delegate,FA(this._delegate))}signInWithCredential(e){return Zt(this._delegate,Gc(this._delegate,e))}signInWithCustomToken(e){return Zt(this._delegate,BA(this._delegate,e))}signInWithEmailAndPassword(e,n){return Zt(this._delegate,KA(this._delegate,e,n))}signInWithEmailLink(e,n){return Zt(this._delegate,QA(this._delegate,e,n))}signInWithPhoneNumber(e,n){return Uh(this._delegate,Kk(this._delegate,e,n))}async signInWithPopup(e){return bo(Zu(),this._delegate,"operation-not-supported-in-this-environment"),Zt(this._delegate,tC(this._delegate,e,Ai))}async signInWithRedirect(e){return bo(Zu(),this._delegate,"operation-not-supported-in-this-environment"),await $h(this._delegate),lC(this._delegate,e,Ai)}updateCurrentUser(e){return this._delegate.updateCurrentUser(e)}verifyPasswordResetCode(e){return WA(this._delegate,e)}unwrap(){return this._delegate}_delete(){return this._delegate._delete()}linkUnderlyingAuth(){this._delegate.wrapped=()=>this}}Bh.Persistence=rn;function Jp(t,e,n){let i=t;typeof t!="function"&&({next:i,error:e,complete:n}=t);const s=i;return{next:o=>s(o&&si.getOrCreate(o)),error:e,complete:n}}function OO(t,e){const n=TO(t,e);if(typeof self<"u"&&!n.includes(wa)&&n.push(wa),typeof window<"u")for(const i of[sf,Ps])n.includes(i)||n.push(i);return n.includes(Vr)||n.push(Vr),n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const NO=F;class xO{constructor(e,n,i=zi.app()){var s;NO((s=i.options)===null||s===void 0?void 0:s.apiKey,"invalid-api-key",{appName:i.name}),this._delegate=new Wk(e,n,i.auth()),this.type=this._delegate.type}clear(){this._delegate.clear()}render(){return this._delegate.render()}verify(){return this._delegate.verify()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const MO="auth-compat";function RO(t){t.INTERNAL.registerComponent(new Kn(MO,e=>{const n=e.getProvider("app-compat").getImmediate(),i=e.getProvider("auth");return new Bh(n,i)},"PUBLIC").setServiceProps({ActionCodeInfo:{Operation:{EMAIL_SIGNIN:dr.EMAIL_SIGNIN,PASSWORD_RESET:dr.PASSWORD_RESET,RECOVER_EMAIL:dr.RECOVER_EMAIL,REVERT_SECOND_FACTOR_ADDITION:dr.REVERT_SECOND_FACTOR_ADDITION,VERIFY_AND_CHANGE_EMAIL:dr.VERIFY_AND_CHANGE_EMAIL,VERIFY_EMAIL:dr.VERIFY_EMAIL}},EmailAuthProvider:Yi,FacebookAuthProvider:Ln,GithubAuthProvider:Vn,GoogleAuthProvider:Pn,OAuthProvider:Ar,SAMLAuthProvider:Ql,PhoneAuthProvider:df,PhoneMultiFactorGenerator:l_,RecaptchaVerifier:xO,TwitterAuthProvider:Fn,Auth:Bh,AuthCredential:no,Error:Gt}).setInstantiationMode("LAZY").setMultipleInstances(!1)),t.registerVersion(fO,mO)}RO(zi);var LO="firebase",PO="9.10.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vf(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function A0(t){const e=t.mapValue.fields.__previous_value__;return Vf(e)?A0(e):e}function Da(t){const e=Ui(t.mapValue.fields.__local_write_time__.timestampValue);return new We(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ix{constructor(e,n,i,s,r,o,a,l){this.databaseId=e,this.appId=n,this.persistenceKey=i,this.host=s,this.ssl=r,this.forceLongPolling=o,this.autoDetectLongPolling=a,this.useFetchStreams=l}}class Bi{constructor(e,n){this.projectId=e,this.database=n||"(default)"}static empty(){return new Bi("","")}get isDefaultDatabase(){return this.database==="(default)"}isEqual(e){return e instanceof Bi&&e.projectId===this.projectId&&e.database===this.database}}function tl(t){return t==null}function Aa(t){return t===0&&1/t==-1/0}function k0(t){return typeof t=="number"&&Number.isInteger(t)&&!Aa(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function P0(t,e){if(t.gt){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Aa(e)?"-0":e}}function V0(t){return{integerValue:""+t}}function F0(t,e){return k0(e)?V0(e):P0(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gg={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0};class Jt{constructor(e,n,i){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=n,this.maximumSequenceNumbersToCollect=i}static withCacheSize(e){return new Jt(e,Jt.DEFAULT_COLLECTION_PERCENTILE,Jt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bL(t){t=Ae(t,Be);const e=Ae(t.firestore,Ze);return Qb(bt(e),t._key).then(n=>Dm(e,t,n))}class lr extends Sm{constructor(e){super(),this.firestore=e}convertBytes(e){return new Qn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Be(this.firestore,null,n)}}function IL(t){t=Ae(t,Be);const e=Ae(t.firestore,Ze),n=bt(e),i=new lr(e);return LR(n,t._key).then(s=>new hi(e,i,t._key,s,new Es(s!==null&&s.hasLocalMutations,!0),t.converter))}function EL(t){t=Ae(t,Be);const e=Ae(t.firestore,Ze);return Qb(bt(e),t._key,{source:"server"}).then(n=>Dm(e,t,n))}function _c(t){t=Ae(t,$t);const e=Ae(t.firestore,Ze),n=bt(e),i=new lr(e);return fI(t._query),Zb(n,t._query).then(s=>new Gi(e,i,t,s))}function TL(t){t=Ae(t,$t);const e=Ae(t.firestore,Ze),n=bt(e),i=new lr(e);return PR(n,t._query).then(s=>new Gi(e,i,t,s))}function SL(t){t=Ae(t,$t);const e=Ae(t.firestore,Ze),n=bt(e),i=new lr(e);return Zb(n,t._query,{source:"server"}).then(s=>new Gi(e,i,t,s))}function mv(t,e,n){t=Ae(t,Be);const i=Ae(t.firestore,Ze),s=Cu(t.converter,e,n);return dl(i,[Au(or(i),"setDoc",t._key,s,t.converter!==null,n).toMutation(t._key,He.none())])}function pv(t,e,n,...i){t=Ae(t,Be);const s=Ae(t.firestore,Ze),r=or(s);let o;return o=typeof(e=te(e))=="string"||e instanceof Wi?Im(r,"updateDoc",t._key,e,n,i):bm(r,"updateDoc",t._key,e),dl(s,[o.toMutation(t._key,He.exists(!0))])}function DL(t){return dl(Ae(t.firestore,Ze),[new co(t._key,He.none())])}function _I(t,e){const n=Ae(t.firestore,Ze),i=yc(t),s=Cu(t.converter,e);return dl(n,[Au(or(t.firestore),"addDoc",i._key,s,t.converter!==null,{}).toMutation(i._key,He.exists(!1))]).then(()=>i)}function bI(t,...e){var n,i,s;t=te(t);let r={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||ud(e[o])||(r=e[o],o++);const a={includeMetadataChanges:r.includeMetadataChanges};if(ud(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(i=h.error)===null||i===void 0?void 0:i.bind(h),e[o+2]=(s=h.complete)===null||s===void 0?void 0:s.bind(h)}let l,c,u;if(t instanceof Be)c=Ae(t.firestore,Ze),u=ao(t._key.path),l={next:h=>{e[o]&&e[o](Dm(c,t,h))},error:e[o+1],complete:e[o+2]};else{const h=Ae(t,$t);c=Ae(h.firestore,Ze),u=h._query;const d=new lr(c);l={next:f=>{e[o]&&e[o](new Gi(c,d,h,f))},error:e[o+1],complete:e[o+2]},fI(t._query)}return function(h,d,f,g){const b=new Iu(g),D=new lm(d,b,f);return h.asyncQueue.enqueueAndForget(async()=>rm(await Yr(h),D)),()=>{b.Rc(),h.asyncQueue.enqueueAndForget(async()=>om(await Yr(h),D))}}(bt(c),u,a,l)}function AL(t,e){return VR(bt(t=Ae(t,Ze)),ud(e)?e:{next:e})}function dl(t,e){return function(n,i){const s=new mt;return n.asyncQueue.enqueueAndForget(async()=>dR(await ym(n),i,s)),s.promise}(bt(t),e)}function Dm(t,e,n){const i=n.docs.get(e._key),s=new lr(t);return new hi(t,s,e._key,i,new Es(n.hasPendingWrites,n.fromCache),e.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kL extends class{constructor(e,n){this._firestore=e,this._transaction=n,this._dataReader=or(e)}get(e){const n=Di(e,this._firestore),i=new wL(this._firestore);return this._transaction.lookup([n._key]).then(s=>{if(!s||s.length!==1)return z();const r=s[0];if(r.isFoundDocument())return new La(this._firestore,i,r.key,r,n.converter);if(r.isNoDocument())return new La(this._firestore,i,n._key,null,n.converter);throw z()})}set(e,n,i){const s=Di(e,this._firestore),r=Cu(s.converter,n,i),o=Au(this._dataReader,"Transaction.set",s._key,r,s.converter!==null,i);return this._transaction.set(s._key,o),this}update(e,n,i,...s){const r=Di(e,this._firestore);let o;return o=typeof(n=te(n))=="string"||n instanceof Wi?Im(this._dataReader,"Transaction.update",r._key,n,i,s):bm(this._dataReader,"Transaction.update",r._key,n),this._transaction.update(r._key,o),this}delete(e){const n=Di(e,this._firestore);return this._transaction.delete(n._key),this}}{constructor(e,n){super(e,n),this._firestore=e}get(e){const n=Di(e,this._firestore),i=new lr(this._firestore);return super.get(e).then(s=>new hi(this._firestore,i,n._key,s._document,new Es(!1,!1),n.converter))}}function CL(t,e,n){t=Ae(t,Ze);const i=Object.assign(Object.assign({},yL),n);return function(s){if(s.maxAttempts<1)throw new R(E.INVALID_ARGUMENT,"Max attempts must be at least 1")}(i),FR(bt(t),s=>e(new kL(t,s)),i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
