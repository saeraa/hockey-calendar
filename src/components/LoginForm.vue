<template>
  ...
  <vee-form @submit="login" :validation-schema="loginSchema" autocomplete="off">
    ...
    <div class="input">
      ...
      <vee-field type="email" name="email" class="input-field" v-on:input="check" autocomplete="off" value=" " />
    ...
    <div class="input">
      ...
      <vee-field type="password" name="password" class="input-field" v-on:input="check" />
