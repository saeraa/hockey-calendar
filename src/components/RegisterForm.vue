<template>
  ...
  <vee-form :validation-schema="schema" @submit="register">
    ...
    <div class="input">
      ...
      <vee-field v-on:input="check" class="input-field" type="text" name="name"></vee-field>
    ...
    <div class="input">
      ...
      <vee-field v-on:input="check" type="email" name="email" class="input-field" />
    ...
    <div class="input">
      ...
      <vee-field v-on:input="check" name="password" type="password" class="input-field password-field" />
    ...
    <div class="input">
      <ErrorMessage name="confirm_password" class="error" />
      <vee-field v-on:input="check" name="confirm_password" type="password" class="input-field password-field" />
      <i class="fas fa-solid fa-eye eye-icon" @click="revealPassword"></i>
